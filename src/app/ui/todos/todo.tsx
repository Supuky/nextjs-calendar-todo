        ...
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
            <div className="p-5 w-72">
                ...
                <div className="flex justify-between">
                    ...
                    <Link href={`todos/${id}/edit`} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-violet-700 rounded-md hover:bg-violet-600 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-violet-700 dark:hover:bg-violet-600 dark:focus:ring-blue-800">
                        Read
                    </Link>
                </div>
            </div>
